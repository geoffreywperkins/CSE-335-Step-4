...
namespace Testing
{
	...
	public:
		...
		TEST_METHOD(TestCCityVisitor)
		{
			...
			// Test that it doesn't call anything on an empty City
			CTestVisitor visitor;
			city.Accept(&visitor);

			Assert::AreEqual(0, visitor.mNumBuildings, L"Visitor number of roads");
			Assert::AreEqual(0, visitor.mNumCoalmines, L"Visitor number of roads");
			Assert::AreEqual(0, visitor.mNumLandscapes, L"Visitor number of roads");
			...
			city.Accept(&visitor);
			Assert::AreEqual(1, visitor.mNumBuildings, L"Visitor number of roads");
			Assert::AreEqual(1, visitor.mNumCoalmines, L"Visitor number of roads");
			Assert::AreEqual(1, visitor.mNumLandscapes, L"Visitor number of roads");
